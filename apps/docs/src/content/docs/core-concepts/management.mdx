...
Use [`getQueueViewSummaries()`](/monque/api/classes/monque/#getqueueviewsummaries) to list operator-facing Job Name groups without reading MongoDB outside core.
