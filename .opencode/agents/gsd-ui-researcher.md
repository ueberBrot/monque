...
Use template from `/Users/debruyn/Code/privates/monque/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/debruyn/Code/privates/monque/.opencode/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/debruyn/Code/privates/monque/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
