...
- **Global scope**: `/Users/debruyn/Code/privates/monque/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/debruyn/Code/privates/monque/.opencode/notes/`)
...
2. Glob `/Users/debruyn/Code/privates/monque/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/Users/debruyn/Code/privates/monque/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/debruyn/Code/privates/monque/.opencode/notes/` — works in any directory
