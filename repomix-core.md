...
## File: packages/core/tests/integration/management.test.ts
````typescript
import {
	cleanupTestDb,
	getTestDb,
...
## File: packages/core/tests/unit/selector.test.ts
````typescript
import { describe, expect, it } from 'vitest';
...
## File: packages/core/tests/unit/shutdown-race.test.ts
````typescript
...
## File: packages/core/tests/unit/cursor.test.ts
````typescript
import { ObjectId } from 'mongodb';
import { describe, expect, it } from 'vitest';
